    ...
    list: [
      {
        ...
        list: [
          ...
          {
            name: { fr: "Machine Learning", en: "Machine Learning" },
          },
          {
            name: { fr: "Vision par ordinateur", en: "Computer Vision" },
          },
          {
            name: { fr: "Céramique", en: "Ceramics" },
          },
          {
            name: { fr: "Design d'objet", en: "Object Design" },
          },
          {
            name: { fr: "Web", en: "Web" }
          },
      ...
      {
        title:  {
          fr: "Design et Céramique",
          en: "Ceramic Design"
        },
        list: [
          {
            name: { fr: "Composer une engobe", en: "Ceramics Slip Design" },
          },
          {
            name: { fr: "Techniques de la plaque", en: "Plate techniques" },
          },
          {
            name: { fr: "Dessin industriel", en: "Industrial design" },
          },
          {
            name: { fr: "Cuisson", en: "Ceramics Firing" },
          },
          {
            name: { fr: "Décoration par trempage", en: "Dipping decoration" },
          },
          {
            name: { fr: "Sérigraphie sur céramique", en: "Silkscreen on Ceramics" }
          },
        ],
      },
      {
        ...
        list: [
          { name: {all: "Python, JS, Matlab"}},
          { name: {all: "Tensorflow, Caffe, pyTorch"}},
          { name: {all: "React, GatsbyJS"}},
          { name: {all: "Flask, Django, REST APIs"}},
          { name: {all: "Timber, Wordpress"}},
          { name: {all: "Blender, OpenSCAD"}},
          { name: {all: "Three.js, p5.js"}},
          { name: {all: "Google Cloud"}},
          { name: {all: "Illustrator, Photoshop, InDesign"}},
        ]
      },
    ]
  },
