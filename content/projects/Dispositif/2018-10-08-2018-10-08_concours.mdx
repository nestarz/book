...
<ul style="color: white; display: flex; text-align: center;margin-bottom: 30px; justify-content: center;">
<li style="background-color: #d83f43; flex-grow: 1;padding: 1em; margin-right: 1em">Rouge brique</li>
<li style="background-color: #6d90ec; flex-grow: 1;padding: 1em; margin-right: 1em">Bleu lavande</li>
<li style="background-color: #6cedc8; flex-grow: 1;padding: 1em">Vert d'eau</li>
</ul>
