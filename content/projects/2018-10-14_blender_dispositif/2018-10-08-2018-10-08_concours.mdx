...
<div style="color: white; display: flex; text-align: center;margin-bottom: 30px;">
<div style="background-color: #d83f43; flex-grow: 1;margin: 3px;">Rouge brique</div>
<div style="background-color: #6d90ec; flex-grow: 1;margin: 3px;">Bleu lavande</div>
<div style="background-color: #6cedc8; flex-grow: 1;margin: 3px;">Vert d'eau</div>
</div>
