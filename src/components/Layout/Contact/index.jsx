...
const Contact = ({ data, withIcons = true, withPhone = true, withEmail = true, withCv = true, ...props }) => {
  ...
  let phoneNumber, formtattedPhone = "", splittedEmail;
  ...
  if (withPhone) {
    ...
    formtattedPhone = language == "fr" ? phoneNumber.formatNational() : phoneNumber.formatInternational()
  }
  return (
    <Wrapper {...props}>
      <SocialMedia>
        <a href={authorInfo.github} target="_blank" rel="noopener noreferrer" aria-label="Behance">
        ...
        <a href={authorInfo.linkedin} target="_blank" rel="noopener noreferrer" aria-label="Behance">
          {withIcons ? <FaLinkedin /> : "Linkedin"}
        </a>
        <a href={authorInfo.twitter} target="_blank" rel="noopener noreferrer" aria-label="Dribbble">
